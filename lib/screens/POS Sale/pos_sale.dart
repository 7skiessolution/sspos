...
//           .toUpperCase()
//           .removeAllWhiteSpace()
//           .contains(searchProductCode.toUpperCase().removeAllWhiteSpace())) {
//         result = true;
//         break;
//       }
//     }
...
//                   ? null
//                   : {selectedCustomerType = element.type, cartList.clear()};
...
//       TextEditingController();
//   TextEditingController CGSTPercentageEditingController =
//       TextEditingController();
//   TextEditingController SGSTPercentageEditingController =
//       TextEditingController();
//   TextEditingController IGSTPercentageEditingController =
//       TextEditingController();
//   double vatGst = 0;
//   double sgst = 0;
//   double igst = 0;
...
//     AddToCartModel productInCart =
//         AddToCartModel(productPurchasePrice: 0, serialNumber: []);
...
//                                   } else {
//                                     return Text(
//                                         lang.S.of(context).noSerailNumberFound);
//                                   }
//                                 },
//                                 gridDelegate:
...
//                                       quantity: selectedSerialNumbers.isEmpty
//                                           ? 1
...
//                                         newSerialNumbers:
//                                             selectedSerialNumbers)) {
//                                       if (int.parse(productModel.productStock) <
//                                           1) {
...
//                                     borderRadius: BorderRadius.circular(5.0),
//                                     side:
//                                         const BorderSide(color: kLitGreyColor),
//                                   ),
//                                   child: Container(
//                                     width: context.width() < 1080
//                                         ? 1080 * .13
...
//                                           ),
//                                         ).onTap(() =>
//                                             finalUserRoleModel.partiesPermission
//                                                 ? AddCustomer(
...
//                                                         child: AppTextField(
//                                                           controller:
//                                                               CGSTPercentageEditingController,
//                                                           onChanged: (value) {
//                                                             if (value == '') {
//                                                               setState(() {
//                                                                 vatGst = 0.0;
//                                                                 CGSTAmountEditingController
//                                                                         .text =
//                                                                     0.toString();
//                                                               });
//                                                             } else {
//                                                               setState(() {
//                                                                 vatGst = double.parse(((value.toDouble() /
//                                                                             100) *
//                                                                         getTotalAmount()
//                                                                             .toDouble())
//                                                                     .toStringAsFixed(
...
//                                                         child: AppTextField(
//                                                           controller:
//                                                               SGSTPercentageEditingController,
//                                                           onChanged: (value) {
//                                                             if (value == '') {
//                                                               setState(() {
//                                                                 sgst = 0.0;
//                                                                 SGSTAmountEditingController
//                                                                         .text =
//                                                                     0.toString();
//                                                               });
//                                                             } else {
//                                                               setState(() {
//                                                                 sgst = double.parse(((value.toDouble() /
//                                                                             100) *
//                                                                         getTotalAmount()
//                                                                             .toDouble())
//                                                                     .toStringAsFixed(
...
//                                                         child: AppTextField(
//                                                           controller:
//                                                               IGSTPercentageEditingController,
//                                                           onChanged: (value) {
//                                                             if (value == '') {
//                                                               setState(() {
//                                                                 igst = 0.0;
//                                                                 IGSTAmountEditingController
//                                                                         .text =
//                                                                     0.toString();
//                                                               });
//                                                             } else {
//                                                               setState(() {
//                                                                 igst = double.parse(((value.toDouble() /
//                                                                             100) *
//                                                                         getTotalAmount()
//                                                                             .toDouble())
//                                                                     .toStringAsFixed(
...
//                                                             productList:
//                                                                 cartList,
//                                                             totalAmount: double.parse((getTotalAmount()
//                                                                         .toDouble() +
//                                                                     serviceCharge -
//                                                                     discountAmount +
//                                                                     vatGst +
...
//                                                                               0.8)),
//                                                               child: Text(
//                                                                 int.parse(showProductVsCategory[i]
//                                                                             .productStock) >
//                                                                         0
...
//                                                               showProductVsCategory[i]
//                                                                   .productName,
//                                                           productId: showProductVsCategory[i]
//                                                               .productCode,
//                                                           productPurchasePrice:
//                                                               showProductVsCategory[i]
//                                                                   .productPurchasePrice
