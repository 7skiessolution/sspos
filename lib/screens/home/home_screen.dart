...
import 'package:sspos/uttils/widgets/Sidebar/sidebar_widget.dart';
...
class _MtHomeScreenState extends State<MtHomeScreen> {
  ...
  //   model.reversed.toList().forEach((element) {
  //     TopSellReport report = TopSellReport(
  //         element.productName,
  ...
  //   model.reversed.toList().forEach((element) {
  //     TopCustomer report = TopCustomer(element.customerFullName,
  //         element.dueAmount, element.phoneNumber, element.profilePicture);
  //     customers.add(report);
  //   });
  //   return customers;
  // }
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              //     final purchaseReport =
                              //         ref.watch(purchaseTransitionProvider);
                              //     final dueReport =
                              //         ref.watch(dueTransactionProvider);
                              //     final customer =
                              //         ref.watch(buyerCustomerProvider);
